...
Submit current branch as a pull request for GitHub issue $ARGUMENTS. Add one sentence description, link to the walkthrough demo (`docs/issues/$ARGUMENTS/demo.md`), and acceptance criteria to the content, and a reference to the issue and nothing else.
